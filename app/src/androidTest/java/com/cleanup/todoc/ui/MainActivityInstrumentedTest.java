...
public class MainActivityInstrumentedTest {
    ...
    public void sortTasks() {
        ...
        /*onView(withRecyclerView(R.id.list_tasks).atPositionOnView(0,R.id.lbl_task_name))
                .check(ViewAssertions.matches(atPosition(0, withText("Sujet 1 à 10h10 le 2020-02-27 salle n° 1"))));
*/
        onView(withId(R.id.list_tasks))
                .check(ViewAssertions.matches(atPosition(0, withText("Sujet 3 à 15h30 le 2020-03-12 salle n° 3"))));
